...
module SwaggerClient
  class MessageSendRequest
    # One of Caller IDs listed in your account
    attr_accessor :cid
    ...
    def list_invalid_properties
      ...
      if !@body.nil? && @body.to_s.length > 160
        invalid_properties.push('invalid value for "body", the character length must be smaller than or equal to 160.')
      end
    ...
    def valid?
      return false if !@body.nil? && @body.to_s.length > 160
    ...
    def body=(body)
      if !body.nil? && body.to_s.length > 160
        fail ArgumentError, 'invalid value for "body", the character length must be smaller than or equal to 160.'
      end
